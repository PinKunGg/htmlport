...
function loadfooter() {
    ...
    document.getElementById("footercontent").innerHTML += '<table><tr><td>Coding Ref : <a href="https://www.w3schools.com/" target="_blank">w3school.com</a> , <a href="https://stackoverflow.com/" target="_blank">stackoverflow.com</a></td></tr><tr><td>Font by : <a href="https://fonts.google.com/specimen/Athiti?subset=thai&preview.text=Hi!&preview.text_type=custom#standard-styles" target="_blank">Google Font</a></td></tr><tr><td>For more information about reference can be found in html, css, js files.</td></tr></table>';
}